"use strict";
var buildDone, config, localConfig, logger, mimosaLiveReload, mimosaServer, registration, reloading, __cleanNodeCache, __doServerRestart, __done, __killLiveReload, __refreshLiveReload, __reload, _watchServerSource;
...
_watchServerSource = (function(_this) {
  return function(mimosaConfig, options, next) {
    var folder, ignoreFunct, watch, watcher, _, _i, _len, _ref;
    watcher = null;
    _ = require('lodash');
