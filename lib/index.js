"use strict";
var buildDone, config, localConfig, logger, mimosaLiveReload, mimosaServer, registration, reloading, __cleanNodeCache, __doServerRestart, __done, __killLiveReload, __refreshLiveReload, __reload, __serverRestart, _buildDone, _watchServerSource;
...
registration = function(mimosaConfig, register) {
  ...
  return register(['postBuild'], 'complete', _buildDone);
};

_buildDone = function(mimosaConfig, options, next) {
